...
function sendWXMessage(sendData) {
    return sendPost(wxPush.url, {
        "appToken": wxPush.token,
        "content": sendData.subTitle,
        "summary": sendData.title,//消息摘要，显示在微信聊天页面或者模版消息卡片上，限制长度100，可以不传，不传默认截取content前面的内容。
        ...
        "url": "https://www.baidu.com", //原文链接，可选参数
